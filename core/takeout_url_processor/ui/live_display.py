# plik: core/takeout_url_processor/ui/live_display.py
# Wersja 1.0 - Dashboard dla Narzędzia Naprawy z URL-i Takeout.
# Opis: Zarządza dashboardem na żywo dla procesu naprawy.
# -*- coding: utf-8 -*-
...
class TakeoutUrlProcessorLiveDisplay:
    """Zarządza dashboardem postępu dla operacji naprawy z URL-i Takeout."""

    def __init__(self, total_items: int, console: Console):
        self.console = console
        self._live: Live | None = None
        self._title_text = Text("🔧 Naprawa z Użyciem URL-i z Takeout 🔧", justify="center", style="bold green")
    ...
    def _build_right_panel(self) -> Panel:
        ...
        content = Group(
            ...
            Rule(style="dim"),
            Text.from_markup(f" Prędkość: [green]{speed:.1f} URL/min[/]", justify="right")
        )
    ...
    def _build_layout(self) -> Layout:
        ...
        layout["body"].split_row(Layout(Panel(Group(*self._recent_logs), title="[bold]Ostatnie Akcje[/]"), name="main"), Layout(self._build_right_panel(), name="side", size=50))
        return layout
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        summary = (f"[bold green]Proces naprawy zakończony![/]\n\n"
                   f"  - [green]Pomyślnie przetworzono: {self._counters['sukcesy']}[/]\n"
